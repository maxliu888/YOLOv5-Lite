...
#    parser.add_argument('--weights', type=str, default=r'C:\Users\chen\Desktop\Model_Zoo\model_zoo/v5lite-e.pt', help='weights path')  # from yolov5/models/
    parser.add_argument('--weights', type=str, default=r'D:\Study\Model_code\YOLOv5-Lite-master\runs\train\exp25\weights\last.pt', help='weights path')  # from yolov5/models/
